...
**Large Context Orchestrator for GitLab Duo** -- chunk oversized Merge Requests and run multi-agent security analysis.
...
Copyright 2026 Pranshu Namdeo Chukwunonso Richard Iwenor
